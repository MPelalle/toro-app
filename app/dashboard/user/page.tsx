...
export default async function UserPage() {
  ...
  return <UserPanel user={{ name: badgeProfile.displayName, email: user.email || "", createdAt: user.createdAt.toISOString() }} badges={badgeProfile.badges} stats={{ logins: user.loginCount, seconds: user.appSeconds, habitCompletions, dietLogs }} />;
}
